// run-tests.mjs - offline logic tests for FS25_TimeGuard.
//
// Same harness pattern as the other Realistic Farming repos (IncomeMod,
// SeasonalCropStress). For each tools/test/lua/*_test.lua, builds a single Lua
// program of:
